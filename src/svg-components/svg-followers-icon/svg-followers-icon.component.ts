...
@Component({
  selector: 'app-svg-followers-icon',
  standalone: true,
  template: `
    <svg
      width="24"
    ...
    >
      <path
        d="M20.7925 9.52352C21.5825 10.3136 21.5825 11.5944 20.7925 12.3845C20.0024 13.1745 18.7215 13.1745 17.9315 12.3845C17.1415 11.5944 17.1415 10.3136 17.9315 9.52352C18.7215 8.73349 20.0024 8.73349 20.7925 9.52352"
        stroke="#4A5568"
        stroke-width="1.5"
...
export class SvgFollowersIconComponent {}
